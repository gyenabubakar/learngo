# Solution for *Peer-graded Assignment: Module 4 Activity*, on Coursera
...
- When a philosopher finishes eating (before it has released its locks) it prints “finishing eating <number>” on a line
